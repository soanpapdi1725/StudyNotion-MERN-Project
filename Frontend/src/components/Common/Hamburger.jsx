    ...
    <div ref={ref} className="md:hidden block">
      ...
      <div className="absolute z-99 w-[95%] h-[90%] left-2 right-2 top-14">
        <div
          ...
          } bg-richblack-800 backdrop-blur-lg  w-full flex flex-col px-4 rounded-lg my-4 justify-center duration-300 transition-all transform-3d ease-in-out `}
        >
          <div className="w-full flex flex-col my-10 divide-y-2 divide-richblack-400">
            {/* Profile wala div */}
            {token !== null ? (
                    ...
                    {link.title === "Catalog" ? (
                      ...
                      >
                        ...
                        <div
                          ...
                          }  flex-col bg-richblack-700 rounded-md duration-300 transition-all ease-in-out`}
                        >
                          {sublinks.length ? (
