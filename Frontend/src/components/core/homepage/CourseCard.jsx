...
const CourseCard = ({ element, currentCard, setCurrentCard }) => {
  return (
    <div
      ...
      } w-[100%] md:w-[40%] h-[50%] flex flex-col gap-8 transition-all`}
    >
      ...
      <div className="border-t-2 px-5 py-3 flex flex-row justify-between text-blue-200 text-lg items-between border-pure-greys-400 border-dashed ">
        {/* buttons and links */}
