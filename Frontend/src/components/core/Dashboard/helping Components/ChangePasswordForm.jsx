...
const ChangePasswordForm = () => {
  ...
  const handleOnSubmitPassChange = async (changePassData) => {
    ...
    >
      <div className="flex flex-col gap-1 relative">
        <label htmlFor="CurrPassword">
          Current Password <span className="text-pink-200 text-start">*</span>
        </label>
        <input
          id="CurrPassword"
        ...
        <button
          ...
          className={`text-xl absolute right-3 z-8 top-1/2 -translate-y-1/2 ${
            errors?.currentPassword ? "mt-1" : "mt-3.5"
          }  text-pure-greys-200`}
        >
      ...
      <div className="flex flex-col gap-1 relative">
        <label htmlFor="NewPassword">
          New Password <span className="text-pink-200 text-start">*</span>
        </label>
        <input
          id="NewPassword"
          className="bg-richblack-700 h-10 shadow-[0px_0.9px_0.5px_0.2px_rgba(255,255,255,0.3)] text-pure-greys-5 focus:border-none   border-none text-md md:text-xl px-2 py-2.5 rounded-lg "
      ...
      <div className="flex flex-col gap-1 relative">
        <label htmlFor="CNPassword">
          ...
          <span className="text-pink-200 text-start">*</span>
        </label>
        <input
          id="CNPassword"
          className="bg-richblack-700 h-10 shadow-[0px_0.9px_0.5px_0.2px_rgba(255,255,255,0.3)] text-pure-greys-5 focus:border-none   border-none text-md md:text-xl px-2 py-2.5 rounded-lg "
        ...
        <button
          ...
          className={`text-xl absolute right-3 z-8 top-1/2 -translate-y-1/2 ${
            errors?.confirmPassword ? "mt-1" : "mt-3.5"
          }  text-pure-greys-200`}
        >
